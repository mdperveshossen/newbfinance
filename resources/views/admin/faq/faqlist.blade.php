          ...
          <div class="row">
              <div class="col-lg-4">
                ...
                @endif
                    ...
                    <div class="card-body">
                        <form action="{{ route('why.faq.list.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="details"  id="editor" class="form-control" id="" rows="6" placeholder="Enter Answer"></textarea>
                            </div>
                            <div class="form-group">
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="{{ route('why.faq.list.delete',$whynewb->id) }}" class="btn btn-danger">Delete</a>
                      <a href="{{ route('why.faq.list.show',$whynewb->id) }}" class="btn btn-info">update</a></td>
                  </tr>
                  @endforeach
                </tbody>
              </table>
