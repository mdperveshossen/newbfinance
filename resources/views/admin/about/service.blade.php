          ...
          <div class="row">
              <div class="col-lg-4">
                ...
                @endif
                    ...
                    <div class="card-body">
                        <form action="{{ route('aboutservice.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <img width="250px" src="{{ asset('uploads/about/service') }}/{{ $social->photo }}" class="img-fluid" alt="">
                    </td>
                    <td>
                    <a href="{{ route('aboutservice.delete',$social->id) }}" class="btn btn-danger">Delete</a>
                    <a href="{{ route('aboutservice.show',$social->id) }}" class="btn btn-info">Update</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
