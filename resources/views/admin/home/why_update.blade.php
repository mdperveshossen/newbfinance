...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      ...
      <a class="breadcrumb-item" href="{{ route('why.newb.index') }}" >Why NEWb</a>
      <a class="breadcrumb-item active">Update Why NEWb</a>
    </nav>

    <div class="sl-pagebody">
      <div class="sl-page-title">
        <h5>Update WHY NEWb</h5>
      </div><!-- sl-page-title -->
        <div class="container">
          <div class="row">
              <div class="col-lg-6 m-auto">
                ...
                @endif
                    <div class="card-header card-header-default bg-info">
                        <h3>Update WHY NEWb </h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('why.newb.update', $info->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
